...
`actions/checkout` v7と`actions/setup-node` v7はNode 24 runtimeを使用します。
self-hosted runnerまたはGHESでは[Actions Runner v2.327.1](https://github.com/actions/runner/releases/tag/v2.327.1)以上を使用してください。
Docker container actionからcheckoutの認証済みGit操作を行う場合は[v2.329.0](https://github.com/actions/runner/releases/tag/v2.329.0)以上を使用してください。
