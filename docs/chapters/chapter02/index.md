...
- 公開ページ：GitHubワークフロー実践ガイド（第13章） https://itdojp.github.io/github-workflow-book/chapters/chapter13/
- サンプル（merge queue 対応CI） https://github.com/itdojp/github-workflow-book/tree/main/examples/merge-queue-ci-example
