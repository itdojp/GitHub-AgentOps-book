...
<figure id="figure-mcp-tool-exposure-boundaries" class="concept-figure" tabindex="0">
  <img
    src="./mcp-trust-secret-boundaries.svg"
    alt="Agentへのtool公開をgateで制御し、外部MCPをtrust boundary、Secret storeをsecret boundaryで分離して監査ログへ接続する図。"
  >
  <figcaption>図7-1：MCP / tool exposureにおけるtrust boundaryとsecret boundary</figcaption>
</figure>
