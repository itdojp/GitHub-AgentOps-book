...
<figure id="figure-human-agent-ci-responsibility-boundary" class="concept-figure" tabindex="0">
  <img
    src="./responsibility-boundaries.svg"
    alt="Humanが仕様・承認・Mergeの最終責任を持ち、Agentが調査・実装・反復、CIが品質ゲートと監査ログを担う責任境界図。"
  >
  <figcaption>図1-1：Human / Agent / CIの責任境界と自動化の停止線</figcaption>
</figure>
